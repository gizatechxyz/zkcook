...
class ModelTrainer:
    ...
    def train_xgb(self, X_train, y_train, X_eval, y_eval, params, eval_metric='auc', early_stopping_rounds=10):
    ...
    def train_lgb(self, X_train, y_train, X_eval, y_eval, params, eval_metric='auc', early_stopping_rounds=10):
    ...
    def train_catboost(self, X_train, y_train, X_eval, y_eval, params, eval_metric='AUC', early_stopping_rounds=10):
    ...
    def train_model(self, X_train, y_train, X_eval, y_eval, params, eval_metric='auc', early_stopping_rounds=10):

        if self.model_type in self.model_trainers_by_name:
            train_func = self.model_trainers_by_name[self.model_type]
            trained_model = train_func(X_train, y_train, X_eval, y_eval, params, eval_metric=eval_metric, early_stopping_rounds=early_stopping_rounds)
